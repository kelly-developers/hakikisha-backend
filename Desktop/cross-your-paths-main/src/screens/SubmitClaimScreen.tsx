...
// Define the categories array with only the three specified categories
const categories = [
  { id: '1', name: 'governance' },
  { id: '2', name: 'misinformation' },
  { id: '3', name: 'civic process' },
];
          ...
          <View className="flex-row flex-wrap justify-center gap-2">
            {categories.map(cat => (
              <TouchableOpacity
                ...
                className="px-4 py-3 rounded-xl min-w-[100px]">
                <Text
                  className={`text-sm font-pmedium text-center ${
