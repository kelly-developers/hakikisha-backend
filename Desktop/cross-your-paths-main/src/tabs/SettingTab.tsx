  ...
  return (
    <ScrollView className="flex-1 bg-background" showsVerticalScrollIndicator={false}>
      ...
      <View className="bg-white pt-4 pb-4 px-6 border-b border-gray-200">
        <Text className="text-gray-900 text-base font-pbold">Settings</Text>
      ...
      <View className="px-5 mt-4">
        <TouchableOpacity 
          className="bg-white rounded-xl p-3 mb-2 shadow-sm flex-row items-center justify-between border border-gray-100"
          onPress={() => navigation.navigate('Profile')}>
          <View className="flex-row items-center">
            <Image source={icons.profile} className="w-5 h-5 mr-3" resizeMode="contain" />
            <Text className="text-gray-800 font-pmedium text-sm">My Profile</Text>
          </View>
          <Image source={icons.arrow_right} className="w-4 h-4" resizeMode="contain" />
        </TouchableOpacity>
